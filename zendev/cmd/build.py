...
packlists = {
        ...
        'nfvimon': 'pkg/zenoss_nfvimon_zenpacks.mk',
    }
...
def build_zenoss(args, env):
    ...
    with env.buildroot.as_cwd():
        ...
        if any(("devimg" in t for t in target)):
            ...
            os.environ['devimg_TAGNAME']='zendev/devimg:' + env.name
...
def add_commands(subparsers):
    ...
    build_parser.add_argument('--nfvimon', action="store_true", required=False,
            help="Install NFVIMON ZenPacks")
    build_parser.add_argument('target', metavar='TARGET', nargs="+",
                              choices=['src', 'core', 'resmgr', 'ucspm', 'nfvimon',
                                       'svcdef-core', 'svcdef-resmgr', 'svcdef-ucspm', 'svcdef-nfvimon',
                                       'svcdefpkg-core', 'svcdefpkg-resmgr', 'svcdefpkg-ucspm', 'svcdefpkg-nfvimon',
                                       'svcpkg-core', 'svcpkg-resmgr', 'svcpkg-ucspm', 'svcpkg-nfvimon', 'svcpkg',
                                       'serviced', 'devimg', 'img-core', 'devimg-interactive',
                                       'img-resmgr', 'img-ucspm', 'img-nfvimon', 'rps-img-core',
                                       'rps-img-resmgr', 'rps-img-ucspm', 'res-img-nfvimon', 'impact-devimg', 'analytics-devimg',
                                       'docker_svcdefpkg-core', 'docker_svcdefpkg-resmgr', 'docker_svcdefpkg-ucspm', 'docker_svcdefpkg-nfvimon'])
