...
echo "if [ ! -e /root/.ssh/github_rsa ]; then"
echo "  cat <<EOF> /root/.ssh/github_rsa"
echo "$(cat ~/.ssh/id_rsa)"
echo "EOF"
...
echo "    User git"
echo "    IdentityFile ~/.ssh/github_rsa"
echo "EOF"
echo "  chmod 600 /root/.ssh/*"
echo "  fi"
echo "if [ ! -e /home/zenoss/.ssh/github_rsa ]; then"
echo "  cat <<EOF> /home/zenoss/.ssh/github_rsa"
echo "$(cat ~/.ssh/id_rsa)"
echo "EOF"
...
echo "  "
echo "EOF"
echo "  chown zenoss:zenoss /home/zenoss/.ssh/github_rsa"
echo "  chmod 600 /home/zenoss/.ssh/github_rsa"
echo "fi"
